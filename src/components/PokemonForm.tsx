...
const PokemonForm = ({
  ...
  return (
    <form className="pokemon-form" onSubmit={handleSubmit}>
      <input
        className="pokemon-input"type="text"name="pokemon"value={pokemon}placeholder="Busca tu pokemon"//Actualizas el valor del input cuando el usuario ingresa un text
        onChange={(e) => setPokemon(e.target.value)}autoComplete="off"/>
